...
void Car::setFirm(const string firm_)
{
	firm = firm_;
}
void Car::setModel(const string model_)
{
	model = model_;
}
void Car::setNumber(const int number_)
{
	number = number_;
}
void Car::setPrice(const double price_)
{
	price = price_;
}
void Car::setYear(const int year_)
{
	year = year_;
}
void Car::setMileage(const int mileage_)
{
	mileage = mileage_;
}
